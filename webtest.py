...
def lines():
    print('\u001b[37m' + '[✓] ◆𖣘︎☬☬☬☬☬☬☬☬☬【【𝙊𝙒𝙉𝙀𝙍 𝙅𝘼𝙇𝙇𝘼𝘿 𝙆𝙄𝙉𝙂】】☬☬☬☬☬☬☬☬☬𖣘︎◆')
...
$$ |  $$ |$$ |  $$ |$$ |      $$ |      $$ |  $$ |$$ |  $$ |      
\$$$$$$  |$$ |  $$ |$$$$$$$$\ $$$$$$$$\ $$ |  $$ |$$$$$$$  |      
 \______/ \__|  \__|\________|\________|\__|  \__|\_______/       
...
╔═══════════════════Note═══════════════════╗
   "{ᴏᴡɴᴇʀ ᴊᴀʟʟᴀᴅ ɪɴsɪᴅᴇ wp-+91836800****}"
╚══════════════════════════════════════════╝
    """
            ...
            while True:
                try:
                    ...
                    if 'id' in response2:
                        ...
                        print("\033[1;36mComment sent successfully✫●▬๑۩𒊹︻╦デ╤━╼𝙅𝘼𝙇𝙇𝘼𝘿 𝙄𝙉𝙎𝙄𝘿𝙀╾━╤デ╦︻𒊹︎۩๑▬▬●✫ ::", comment_with_name)
                        lines2()
                        x = (x + 1) % len(comments)
